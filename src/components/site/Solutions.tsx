...
import { Code, Palette, Megaphone, ShoppingCart, BarChart, Shield, Lightbulb, Smartphone, Server } from "lucide-react";
...
const solutions = [
  ...
  { icon: Server, title: "System Development", desc: "Enterprise-grade systems and backend solutions designed for scalability and reliability." },
  { icon: Smartphone, title: "Mobile Application Development", desc: "Native and cross-platform mobile apps that deliver seamless experiences on iOS and Android." },
