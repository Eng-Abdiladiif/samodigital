    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden">
        <div className="relative h-[640px] md:h-[720px]">
          <img src={heroImg} alt="Creative agency team collaborating" className="absolute inset-0 h-full w-full object-cover opacity-70" width={1920} height={1088} />
          ...
          <div className="relative container-tight h-full flex flex-col justify-center items-center text-center pt-12">
            <span className="section-label mb-6 animate-fade-in"> Samo Digital Agency</span>
            <h1 className="text-4xl md:text-7xl font-semibold leading-[1.02] text-balance max-w-4xl animate-fade-up">
              Experience our expert<br />agency services
            </h1>
            <p className="mt-6 text-muted-foreground max-w-xl animate-fade-up">
            ...
            <MoveDown className="mt-10 h-5 w-5 text-muted-foreground animate-bounce" />
          </div>
        </div>
      ...
      <section className="py-28 container-tight">
        <div className="grid md:grid-cols-[2fr_1fr] gap-12 items-end">
          ...
          <div className="flex flex-col gap-5">
            ...
            <Button asChild variant="ghostPill" className="self-start">
              <Link to="/about">See more <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 container-tight">
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-12 items-start mb-12">
          ...
          <div className="md:pt-10">
            ...
            <Button asChild variant="ghostPill" className="mt-5">
              <Link to="/services">Explore our services <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-5 flex items-center justify-between">
                  ...
                  <Button asChild variant="hero" size="sm" className="h-9">
                    <Link to="/projects">View detail</Link>
                  </Button>
                </div>
              </div>
            </article>
          ...
          <div className="surface-card p-8 md:col-span-2">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <Button asChild variant="ghostPill" size="sm" className="mt-5"><Link to="/about">Learn more</Link></Button>
              </div>
            </div>
          </div>
