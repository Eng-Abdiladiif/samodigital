...
import { ArrowRight, Check, Code2, Palette, Megaphone, Search, PenTool, Smartphone } from "lucide-react";
...
const tiers = [
  { name: "Starter", price: "$2.5k", desc: "For early teams shipping their first MVP.", features: ["Landing page", "Brand starter kit", "Analytics setup", "1 round of revisions"] },
  { name: "Growth", featured: true, price: "$8k", desc: "For scaling brands ready to compound.", features: ["5–8 page site", "Design system", "CMS integration", "SEO foundations", "3 rounds of revisions"] },
  ...
  <SiteLayout>
    ...
    <section className="container-tight py-24">
      ...
      <div className="grid md:grid-cols-3 gap-5 mt-12">
        {tiers.map((t) => (
          <div key={t.name} className={`surface-card p-8 ${t.featured ? "border-primary/50 bg-primary/5" : ""}`}>
            ...
            <Button asChild variant={t.featured ? "hero" : "ghostPill"} className="mt-7 w-full">
    ...
    <section className="container-tight py-12">
      <div className="surface-card p-12 text-center">
        ...
        <Button asChild variant="hero" size="lg" className="mt-6"><Link to="/contact">Book a call <ArrowRight className="h-4 w-4" /></Link></Button>
      </div>
    </section>
  </SiteLayout>
);
