...
import { LogosSlider } from "@/components/site/LogosSlider";
...
import { 
  ...
  NodeJsLogo, 
  FramerLogo 
} from "@/components/site/TechLogos";
...
const services = [
  ...
  { n: "03", title: "Mobile Application Development", desc: "Native and cross-platform mobile solutions for iOS and Android that deliver exceptional user experiences." },
  { n: "04", title: "Brand Strategy", desc: "Positioning, identity, and narrative that make your brand impossible to ignore." },
  { n: "05", title: "ERP Consulting", desc: "Strategic implementation and optimization of enterprise resource planning systems for seamless business operations." },
  { n: "06", title: "Digital Marketing", desc: "Data-driven campaigns that amplify your reach, engage audiences, and drive measurable growth." },
];
      ...
      <section className="py-24 container-tight overflow-hidden">
        <FadeIn direction="up">
          <SectionHeader
            ...
            title={<>Built with <span className="highlight-mark">industry-leading</span> technologies</>}
            description="We leverage cutting-edge tools and frameworks to deliver exceptional digital experiences."
          />
        </FadeIn>
        <FadeIn direction="up" delay={0.2} className="mt-16">
          <LogosSlider
            logos={[
              ...
              { name: "TypeScript", icon: <TypeScriptLogo className="h-10 w-10" /> },
              { name: "Tailwind CSS", icon: <TailwindLogo className="h-8 w-auto" /> },
              { name: "Supabase", icon: <SupabaseLogo className="h-10 w-10" /> },
              { name: "Vercel", icon: <VercelLogo className="h-6 w-auto" /> },
              { name: "Node.js", icon: <NodeJsLogo className="h-12 w-12" /> },
              { name: "Framer Motion", icon: <FramerLogo className="h-10 w-10" /> },
            ]}
          />
        </FadeIn>
      </section>
