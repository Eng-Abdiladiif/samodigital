...
const services = [
  ...
  { icon: Smartphone, title: "Mobile Application Development", desc: "Native and cross-platform mobile solutions that deliver exceptional user experiences.", benefits: ["iOS & Android", "React Native", "App Store optimization"] },
